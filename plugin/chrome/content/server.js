...
songbird_GET_control.controller = function(){
    ...
    var ctl = {
        ...
        status: function() {
            ...
            var playMode;
            var repeatMode;
            switch (c.sequencer.mode) {
                case c.sequencer.MODE_FORWARD: playMode = 'Play: Forward'; break;
                case c.sequencer.MODE_BACKWARD: playMode = 'Play: Backward'; break;
                case c.sequencer.MODE_SHUFFLE: playMode = 'Play: Shuffle'; break;
                default: playMode = 'Play: Unknown';
            }
            switch (c.sequencer.repeatMode) {
                case c.sequencer.MODE_REPEAT_NONE: repeatMode = 'Repeat: None'; break;
                case c.sequencer.MODE_REPEAT_ONE: repeatMode = 'Repeat: One'; break;
                case c.sequencer.MODE_REPEAT_ALL: repeatMode = 'Repeat: All'; break;
                default: repeatMode = 'Repeat: Unknown';
            }
            var mediaItem = c.sequencer.currentItem;
            var nextItem = c.sequencer.nextItem;
            var st = {
                playing: playing,
                playMode: playMode,
            ...
            if(nextItem) {
                st.nextArtist = nextItem.getProperty(SBProperties.artistName);
                st.nextAlbum = nextItem.getProperty(SBProperties.albumName);
                st.nextTrack = nextItem.getProperty(SBProperties.trackName);
            }
            return st;
        },
